...
module checkpointMem_256x912(	// @[Users/kyoukamikura/JLU-NSCSCC-25/chisel-playground/playground/src/core/backend/ooo/RegRenaming.scala:47:34]
  input  [7:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  output [911:0] R0_data,
  input  [7:0]   W0_addr,
  input          W0_en,
                 W0_clk,
  input  [911:0] W0_data
  ...
  reg [911:0] Memory[0:255];	// @[Users/kyoukamikura/JLU-NSCSCC-25/chisel-playground/playground/src/core/backend/ooo/RegRenaming.scala:47:34]
    ...
    initial begin	// @[Users/kyoukamikura/JLU-NSCSCC-25/chisel-playground/playground/src/core/backend/ooo/RegRenaming.scala:47:34]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[Users/kyoukamikura/JLU-NSCSCC-25/chisel-playground/playground/src/core/backend/ooo/RegRenaming.scala:47:34]
        for (logic [8:0] i = 9'h0; i < 9'h100; i += 9'h1) begin
          ...
          Memory[i[7:0]] = _RANDOM_MEM[911:0];	// @[Users/kyoukamikura/JLU-NSCSCC-25/chisel-playground/playground/src/core/backend/ooo/RegRenaming.scala:47:34]
        end	// @[Users/kyoukamikura/JLU-NSCSCC-25/chisel-playground/playground/src/core/backend/ooo/RegRenaming.scala:47:34]
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// @[Users/kyoukamikura/JLU-NSCSCC-25/chisel-playground/playground/src/core/backend/ooo/RegRenaming.scala:47:34]
  ...
  assign R0_data = _R0_en_d0 ? Memory[_R0_addr_d0] : 912'bx;	// @[Users/kyoukamikura/JLU-NSCSCC-25/chisel-playground/playground/src/core/backend/ooo/RegRenaming.scala:47:34]
endmodule
