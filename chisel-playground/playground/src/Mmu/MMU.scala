...
// 处理地址翻译逻辑
  ...
  io.out0.bits.mat := Mux(dmw0_hit_0, io.from_csr.dmw0.mat,
                      Mux(dmw1_hit_0, io.from_csr.dmw1.mat, 
                      Mux(da_mode_0.asBool, io.from_csr.crmd.datf, s2.io.out0.bits.mat)))
  ...
  io.out1.bits.mat := Mux(dmw0_hit_1, io.from_csr.dmw0.mat,
                      Mux(dmw1_hit_1, io.from_csr.dmw1.mat, 
                      Mux(da_mode_1.asBool, io.from_csr.crmd.datm, s2.io.out1.bits.mat)))
