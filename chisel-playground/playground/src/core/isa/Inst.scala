...
object Inst {
    ...
    val table = Array(
        ...
        dbar            -> List(ImmType.si12    , FuType.lsu, LSUOpType.dbar,  SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.n, IsLegal.y, CSROp.nop,     TlbOp.nop,  CACOPType.i, CACOPOp.nop), 
        ...
        idle            -> List(ImmType.si12    , FuType.bru, ALUOpType.idle,  SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.n, IsLegal.y, CSROp.idle,    TlbOp.nop,  CACOPType.i, CACOPOp.nop),
    )
}