...
object Inst {
    ...
    val table = Array(
        add_w           -> List(ImmType.nop     , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y),  
        sub_w           -> List(ImmType.nop     , FuType.alu, ALUOpType.sub,   SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        slt             -> List(ImmType.nop     , FuType.alu, ALUOpType.slt,   SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        sltu            -> List(ImmType.nop     , FuType.alu, ALUOpType.sltu,  SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        nor             -> List(ImmType.nop     , FuType.alu, ALUOpType.nor,   SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        and             -> List(ImmType.nop     , FuType.alu, ALUOpType.and,   SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        or              -> List(ImmType.nop     , FuType.alu, ALUOpType.or,    SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        xor             -> List(ImmType.nop     , FuType.alu, ALUOpType.xor,   SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        mul_w           -> List(ImmType.nop     , FuType.mdu, MDUOpType.mul,   SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        ...
        srl_w           -> List(ImmType.nop     , FuType.alu, ALUOpType.srl,   SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        sra_w           -> List(ImmType.nop     , FuType.alu, ALUOpType.sra,   SrcType.reg, SrcType.reg, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        slli_w          -> List(ImmType.si12    , FuType.alu, ALUOpType.sll,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        srli_w          -> List(ImmType.si12    , FuType.alu, ALUOpType.srl,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        srai_w          -> List(ImmType.si12    , FuType.alu, ALUOpType.sra,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        ld_b            -> List(ImmType.si12    , FuType.lsu, LSUOpType.lb,    SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        ld_h            -> List(ImmType.si12    , FuType.lsu, LSUOpType.lh,    SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        ld_w            -> List(ImmType.si12    , FuType.lsu, LSUOpType.lw,    SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        st_b            -> List(ImmType.si12    , FuType.lsu, LSUOpType.sb,    SrcType.reg, SrcType.imm, SrcIsRd.y, Dest.rd, RfWen.n, IsLegal.y), 
        st_h            -> List(ImmType.si12    , FuType.lsu, LSUOpType.sh,    SrcType.reg, SrcType.imm, SrcIsRd.y, Dest.rd, RfWen.n, IsLegal.y), 
        st_w            -> List(ImmType.si12    , FuType.lsu, LSUOpType.sw,    SrcType.reg, SrcType.imm, SrcIsRd.y, Dest.rd, RfWen.n, IsLegal.y), 
        ld_bu           -> List(ImmType.si12    , FuType.lsu, LSUOpType.lbu,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        ld_hu           -> List(ImmType.si12    , FuType.lsu, LSUOpType.lhu,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        preld           -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        ...
        blt             -> List(ImmType.si16_pc , FuType.bru, ALUOpType.blt,   SrcType.reg, SrcType.reg, SrcIsRd.y, Dest.rd, RfWen.n, IsLegal.y), 
        ...
        addi_w          -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        andi            -> List(ImmType.ui12    , FuType.alu, ALUOpType.and,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        ori             -> List(ImmType.ui12    , FuType.alu, ALUOpType.or,    SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        xori            -> List(ImmType.ui12    , FuType.alu, ALUOpType.xor,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        syscall         -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        break           -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        csrrd           -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        csrwr           -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        csrxchg         -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        dbar            -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        ibar            -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        rdcntid_w       -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        rdcntvl_w       -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        rdcntvh_w       -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        cacop           -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.n, IsLegal.y), 
        tlbsrch         -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        tlbrd           -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        tlber           -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        tlbfill         -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        invtlb          -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        ertn            -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y), 
        idle            -> List(ImmType.si12    , FuType.alu, ALUOpType.add,   SrcType.reg, SrcType.imm, SrcIsRd.n, Dest.rd, RfWen.y, IsLegal.y)
    )
}