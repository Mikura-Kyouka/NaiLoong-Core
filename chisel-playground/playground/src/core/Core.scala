...
class Core extends Module {
  ...
  PipelineConnect(Dispatch.io.out(0), Issue.io.in(0), Issue.io.out(0).fire, flush)
  PipelineConnect(Dispatch.io.out(1), Issue.io.in(1), Issue.io.out(1).fire, flush)
  PipelineConnect(Dispatch.io.out(2), Issue.io.in(2), Issue.io.out(2).fire, flush)
  PipelineConnect(Dispatch.io.out(3), Issue.io.in(3), Issue.io.out(3).fire, flush)
  PipelineConnect(Dispatch.io.out(4), Issue.io.in(4), Issue.io.out(4).fire, flush)
