...
class CPUCSR extends Module {
  ...
  val exceptionIndex = PriorityEncoder(io.exceptionInfo.exceptionVec.asUInt)
  val causeTable = Seq(
      0.U  ->  0.U,   // 原本 bit 0：中断
      1.U  ->  8.U,   // 原本 bit 1：取指地址错
      2.U  -> 63.U,   // 原本 bit 2：TLB 重填
      3.U  ->  3.U,   // 原本 bit 3：取指页无效
      4.U  ->  7.U,   // 原本 bit 4：页权限
      5.U  -> 11.U,   // 原本 bit 5：系统调用
      6.U  -> 12.U,   // 原本 bit 6：断点
      7.U  -> 13.U,   // 原本 bit 7：指令不存在
      8.U  -> 14.U,   // 原本 bit 8：指令特权等级错
      9.U  ->  9.U,   // 原本 bit 9：地址非对齐
      10.U -> 60.U,   // 原本 bit 10：ERET
      11.U -> 63.U,   // 原本 bit 11：TLB 重填
      12.U ->  4.U,   // 原本 bit 12：页修改
      13.U ->  7.U,   // 原本 bit 13：页特权等级错
      14.U ->  2.U,   // 原本 bit 14：store 操作页无效
      15.U ->  1.U    // 原本 bit 15：load 操作页无效
    )
